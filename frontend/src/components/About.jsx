      ...
      <div className="max-w-7xl mx-auto px-6">
        ...
        <div className="grid lg:grid-cols-2 gap-16 items-center">
          ...
          >
            ...
            {/* EXPERIENCE BADGE */}
            <motion.div
              className="absolute -bottom-6 -right-6 bg-[#D97706] text-white p-6 rounded-3xl shadow-lg"
              animate={{
                y: [0, -6, 0],
                rotate: [0, 0.5, 0],
              }}
          ...
          >
            ...
            <motion.span
              variants={fadeUp}
              className="inline-block bg-orange-100 text-orange-600 px-4 py-2 rounded-full text-sm font-semibold mb-5"
            >
              ABOUT US
            </motion.span>
            ...
            <motion.h2
              variants={fadeUp}
              className="text-4xl lg:text-5xl font-bold text-[#1F1F1F] leading-tight"
            >
              ...
              {[
                ...
                >
                  <motion.div whileHover={{ rotate: 10, scale: 1.1 }}>
                    <CheckCircle className="text-[#D97706]" size={22} />
                  </motion.div>
                  <span>{item}</span>
                </motion.div>
              ))}
            ...
            <div className="grid md:grid-cols-2 gap-5 mt-10">
              ...
              <motion.div
                ...
                className="bg-[#F7F3EC] p-6 rounded-2xl"
              >
